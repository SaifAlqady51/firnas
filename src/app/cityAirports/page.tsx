...
const AirportInfoPage = () => {
    ...
    const copyText = () => {
        navigator.clipboard.writeText(
            "https://airport-api-gamma.vercel.app/api/airport/get/airportsList?cityName=",
        );
        ...
        <main className=" align-center dark z-0 flex  h-screen flex-col items-center overscroll-x-none bg-[#e2eafc]  dark:bg-dark  dark:text-textColor  ">
            <div className=" my-60   flex h-fit w-4/5 flex-col items-center justify-center">
                ...
                <div className="mb-12 text-xl font-semibold">
                    Use this endpoint if you want to to get all airports in a
                    specific city from airport IATA code{"  "}
                    <p className="mt-6">
                        EX.{" "}
                        https://airport-api-gamma.vercel.app/api/airport/get/airportsList?cityName=London{" "}
                    </p>
                </div>
                {/* endpoint link */}
                <div
                ...
                >
                    <p>
                        https://airport-api-gamma.vercel.app/api/airport/get/airportsList?cityName=&#123;IATACode&#125;{" "}
                    </p>
